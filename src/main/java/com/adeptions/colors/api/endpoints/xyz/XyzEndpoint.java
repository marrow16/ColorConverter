 ...
 * the License.
 */
package com.adeptions.colors.api.endpoints.xyz;
...
/**
 * Endpoint for conversions to CIE-XYZ
 */
@Controller
@RequestMapping("/" + XyzEndpoint.ENDPOINT_URI_XYZ)
public class XyzEndpoint extends AbstractColorEndpoint {
	public static final String ENDPOINT_URI_XYZ = "xyz";
