 ...
 * the License.
 */
package com.adeptions.colors.api.endpoints.cmyk;
...
/**
 * Endpoint for conversions to CMYK
 */
@Controller
@RequestMapping("/" + CmykEndpoint.ENDPOINT_URI_CMYK)
public class CmykEndpoint extends AbstractColorEndpoint {
	public static final String ENDPOINT_URI_CMYK = "cmyk";
		...
		super(new EndpointOptions(RequestMethod.GET)
				.addParameters(
						...
						new ParameterOption(ColorParams.PARAM_NAME_PROFILE,
								"The target CMYK color profile for the conversion",
								"string")
